...
export const Bill = () => {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 right-0 h-screen max-w-5xl w-96 bg-[#1F1D2B] flex flex-col gap-8 pt-5 text-white overflow-y-scroll scrollbar-hide">
        ...
        {orders.map((item) => (
          ...
          >
            <div className="flex flex-row gap-2">
              <div>
                <img src={item.img} className="w-20 h-24 object-cover" />
              </div>
